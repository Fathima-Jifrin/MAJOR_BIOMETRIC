...
// Fetch Aadhaar users
$sql = "SELECT id, full_name, aadhaar_number
FROM aadhaar_data
WHERE index_f IS NULL OR index_f = ''";
        ...
        <tbody>
            <?php foreach ($users as $user): ?>
                <tr>
                    ...
                    <td><a href="scan.php?aadhaar=<?= $user['aadhaar_number'] ?>"><button>Scan Fingerprint</button></a></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
